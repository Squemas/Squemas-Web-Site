...
var globalURLSquemasConnection = localStorage.getItem(globalURLSquemasConnection);   
        ...
        var LoginScript = function() {
            $('#access-form-login').submit(function(event){
                ...
                $.ajax({
                    url: globalURLSquemasConnection + 'access/LoginMethod/',
                    data: data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
                    ...
                    success: function(resultLoginMethod){
                        ...
                        if(resultLoginMethod == 0){
                            ...
                            window.location = globalURLSquemasConnection + 'dashboard';
        ...
        var RegisterScript = function() {
            ...
            $('#access-form-register').submit(function(event){
                    ...
                    $.ajax({
                        url: globalURLSquemasConnection + 'access/RegisterMethod/',
                        data: data,
                        processData: false,
                        contentType: false,
                        type: 'POST',
